        ...
        <Page showMenu showNetworkStatus>
            <div className="relative">
                <Grid columns={2} className="m-0 h-full">
                    <Grid.Column
                        width={openDrawer ? 3 : 1}
                        className={`duration-300 pl-6 transition-transform transition-width pr-0`}
                    >
                    ...
                    <Grid.Column width={1} className="p-0">
                        <Divider
                            vertical
                            className={`duration-300 transition-transform transition-left}`}
                        >
                            <div className="flex">
                                <Button
                    ...
                    <Grid.Column
                        width={openDrawer ? 12 : 14}
                        className="flex flex-col duration-300 transition-transform transition-width pl-0 pr-6"
                    >
