            ...
            <Modal.Content>
                ...
                <Modal.Description className="flex flex-col items-center gap-10">
                    ...
                    <Container className="flex flex-auto flex-col gap-3 px-3 text-center">
                        ...
                        <p>AliceNetWallet keeps track of your wallets by using an encrypted vault file.</p>

                        <p>Any wallets generated by AliceNetWallet, imported via private key or imported via
