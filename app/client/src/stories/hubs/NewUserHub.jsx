...
function NewUserHub() {
    ...
    useEffect(() => {
        ...
        if (vaultLocked && exists) {
            history.push("/returningUserLoad/hasExistingVault");
        }
        if (optout) {
            history.push("/returningUserLoad/hasKeystores");
        }
                ...
                >
                    <Container className="flex flex-auto flex-col gap-3 w-72">
                        ...
                        <Button
                            color="black"
                            basic
                            content="I have a vault seed"
                            fluid
                            onClick={useRecoveryPhrase}
                        />
                    </Container>

                    <Container>
                        <p className="text-teal text-sm">
                            *Don&apos;t worry you&apos;ll be able to import
                            additional wallets later
                        </p>
                    </Container>
                </Grid.Column>
            </Grid>
