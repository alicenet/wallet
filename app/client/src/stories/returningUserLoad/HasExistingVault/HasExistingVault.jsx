...
function UnlockExistingVault() {
    ...
    const [
        showForgottenVaultPasswordModal,
        setShowForgottenVaultPasswordModal,
    ] = useState(false);
    ...
    const { vaultLocked, vaultExists } = useSelector((state) => ({
        vaultLocked: state.vault.is_locked,
    ...
    const handleFormSubmit = async () => {
        setLoading(true);
        dispatch(
            VAULT_ACTIONS.loadSecureHDVaultFromStorage(formState.password.value)
        );
    };
