                ...
                <Grid.Column width={16} className="p-0 text-sm self-center">
                    {keystore ? (
                        <div className="flex flex-col items-center justify-center">
                            ...
                            <p>
                                We just need a name to reference this keystore
                                by
                            </p>

                            <Form
                                size="mini"
                                className="w-60 mt-12 mini-error-form"
                            >
                                <Form.Input
                                    className="text-left"
                        ...
                        <>
                            <p>
                                Please select a password to secure your
                                keystore.
                            </p>

                            <p>
                                The keystore password will be used to lock your
                                keystore. You will need it to load this wallet
                                again.
                            </p>

                            <p>
                                The administrative password is used for general
