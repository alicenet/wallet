...
function ChooseRecoveryEllipticCurve() {
    ...
    const [curveType, setCurveType] = useState(
        desiredCurve || curveTypes.SECP256K1
    );
    ...
    return (
        <Page>
            <Grid textAlign="center" className="m-0">
                ...
                <Grid.Column width={16} className="p-0 self-center">
                    <p className="text-sm">
                        Using this seed phrase, your wallets will be generated.
                    </p>

                    <p className="text-sm">
                        Please make sure to select the same Key Operation Curve
                        that you used when creating the vault.
                    </p>
                </Grid.Column>
