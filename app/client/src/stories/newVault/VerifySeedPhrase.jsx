...
function VerifyYourSeedPhrase() {
    ...
    useEffect(() => {
        setSeedPhraseIsCorrect(
            isDebug
                ? chosenPhrase.length === 12
                : isEqual(chosenPhrase, seedPhrase.split(" "))
        );
        ...
        <Page>
            <Grid textAlign="center" className="m-0">
                <Grid.Column width={16} className="p-0 self-center">
                    <Header
                        content="Verify Your Seed Phrase"
                        as="h3"
                        className="m-0"
                    />
                </Grid.Column>
                ...
                <Grid.Column width={16} className="p-0 self-center">
                    <p>
                        Verify your seed phrase by clicking in the correct
                        order.
                    </p>
                </Grid.Column>
                ...
                <Grid.Column width={12} className="p-0 self-center">
                    <Container className="flex justify-between">
                        ...
                        <Button
                            ...
                            onClick={() =>
                                history.push("/newVault/chooseEllipticCurve")
                            }
                        />
                    </Container>
                </Grid.Column>
