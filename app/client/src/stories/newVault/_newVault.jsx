...
export const VerifySeedPhrase = verifySeedPhrase;
export const ChooseEllipticCurve = chooseEllipticCurve;
export const ChooseRecoveryEllipticCurve = chooseRecoveryEllipticCurve;
export const SecureNewVault = secureNewVault;
export const EnterRecoveryPhrase = enterRecoveryPhrase;