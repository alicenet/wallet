...
export default function AddWalletMenu() {
    ...
    const { vaultExists } = useSelector((state) => ({
    ...
    let walletButtons = [
        {
            ...
            icon: "plus",
            onClick: () => history.push("/addWallet/generateKeystore"),
            basic: false,
        },
        {
            content: "Import Keystore",
            icon: "download",
            onClick: () => history.push("/addWallet/importKeystore"),
            basic: false,
        },
        {
            content: "Import Private Key",
            icon: "download",
            onClick: () => history.push("/addWallet/importPrivateKey"),
            basic: false,
        },
        {
            content: "Go Back",
    ...
    if (vaultExists) {
        walletButtons.unshift({
            ...
            icon: "plus",
            onClick: () => history.push("/addWallet/generate"),
            basic: false,
        });
    }
                ...
                <Grid textAlign="center">
                    <Grid.Column width={16} className="mb-8">
                        ...
                        <div className="text-sm">
                            <p>
                                A wallet can be generated against your mnemonic
                                or imported.
                            </p>

                            <p>
                                Please note that imported wallets are not
                                recoverable from your seed phrase.
                            </p>
                        </div>
                    </Grid.Column>
                    ...
                    <Grid.Column
                        width={16}
                        className="flex flex-auto flex-col items-center gap-5"
                    >
