    ...
    const DefaultRoutes = () => {
        return (
            <>
                ...
                <Route
                    exact
                    path="/optOut/disclaimer"
                    component={OptOutFlow.VaultOptOutDisclaimer}
                />
                <Route
                    exact
                    path="/optOut/createKeystore"
                    component={OptOutFlow.CreateAKeystore}
                />
                <Route
                    exact
                    path="/optOut/useExistingKeystore"
                    component={OptOutFlow.UseExistingKeystore}
                />

                {/* New Vault User Flow */}
                <Route
                    exact
                    path="/newVault/createVault"
                    component={NewVaultFlows.CreateVault}
                />
                <Route
                    exact
                    path="/newVault/getNewSeedPhrase"
                    component={NewVaultFlows.GetNewSeedPhrase}
                />
                <Route
                    exact
                    path="/newVault/verifySeedPhrase"
                    component={NewVaultFlows.VerifySeedPhrase}
                />
                <Route
                    exact
                    path="/newVault/chooseEllipticCurve"
                    component={NewVaultFlows.ChooseEllipticCurve}
                />
                <Route
                    exact
                    path="/newVault/secureNewVault"
                    component={NewVaultFlows.SecureNewVault}
                />

                {/* Restore Vault With Seed User Flow */}
                <Route
                    exact
                    path="/newVault/useRecoveryPhrase"
                    component={NewVaultFlows.EnterRecoveryPhrase}
                />
                <Route
                    exact
                    path="/newVault/chooseRecoveryEllipticCurve"
                    component={NewVaultFlows.ChooseRecoveryEllipticCurve}
                />

                {/* Returning User Load */}
                <Route
                    exact
                    path="/returningUserLoad/hasExistingVault"
                    component={ReturningUserLoadFlows.HasExistingVault}
                />
                <Route
                    exact
                    path="/returningUserLoad/hasKeystores"
                    component={ReturningUserLoadFlows.HasExistingKeystores}
                />
                ...
                <RedirectIfLocked>
                    <WalletHubProvider>
                        <Route
                            exact
                            path="/hub"
                            component={Hubs.ReturningUserHub}
                        />
                ...
                <Route
                    exact
                    path="/addWallet/menu"
                    component={AddWallet.AddWalletMenu}
                />
                <Route
                    exact
                    path="/addWallet/generate"
                    component={AddWallet.GenerateWallet}
                />
                <Route
                    exact
                    path="/addWallet/importKeystore"
                    component={AddWallet.ImportKeystore}
                />
                <Route
                    exact
                    path="/addWallet/importPrivateKey"
                    component={AddWallet.ImportPrivateKey}
                />
                <Route
                    exact
                    path="/addWallet/verify"
                    component={AddWallet.VerifyImport}
                />
                <Route
                    exact
                    path="/addWallet/generateKeystore"
                    component={AddWallet.GenerateKeystore}
                />
                ...
                <RedirectIfLocked>
                    <Route
                        exact
                        path="/transactions"
                        component={Transactions.Construct}
                    />
                    <Route
                        exact
                        path="/inspectTx"
                        component={Transactions.InspectionModule}
                    />
                </RedirectIfLocked>
                ...
                <Route
                    exact
                    path="/wallet/advancedSettings"
                    component={Settings.AdvancedSettings}
                />
            </>
        );
    };
