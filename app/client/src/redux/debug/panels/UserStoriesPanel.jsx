...
export default function UserStoriesPanel() {
    ...
    return (
        <Segment>
            ...
            <Segment>
                ...
                <div className="flex mt-2">
                    <Button
                        {...navButtonProps(
                            "Create Vault Root",
                            "/newVault/createVault"
                        )}
                    />
                    <Button
                        {...navButtonProps(
                            "Get Seed Phrase",
                            "/newVault/getNewSeedPhrase"
                        )}
                    />
                    <Button
                        {...navButtonProps(
                            "Verify Seed Phrase",
                            "/newVault/verifySeedPhrase"
                        )}
                    />
                </div>
                <div className="flex mt-2">
                    <Button
                        {...navButtonProps(
                            "Choose ELL Curve",
                            "/newVault/chooseEllipticCurve"
                        )}
                    />
                    <Button
                        {...navButtonProps(
                            "Secure Vault",
                            "/newVault/secureNewVault"
                        )}
                    />
                </div>
            </Segment>
            ...
            <Segment>
                <Header sub className="text-xs">
                    Recover Vault With Seed
                </Header>
                <div className="flex mt-2">
                    <Button
                        {...navButtonProps(
                            "Enter Recovery Seed",
                            "/newVault/useRecoveryPhrase"
                        )}
                    />
                    <Button
                        {...navButtonProps(
