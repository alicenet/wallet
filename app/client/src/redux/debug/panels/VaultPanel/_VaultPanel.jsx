...
export default function VaultPanel() {
    ...
    const isActiveBlock = (index) =>
        activeBlocks.filter((e) => e === index).length > 0;
    ...
    return (
        <Grid className="mt-1">
            <Grid.Column width={16}>
                <Menu>
                    <Menu.Item
                        active={isActiveBlock(0)}
                        index={0}
                        onClick={handleClick}
                        content="Mnemonic"
                    />
                    <Menu.Item
                        active={isActiveBlock(1)}
                        index={1}
                        onClick={handleClick}
                        content="Vault/Wallets"
                    />
                    <Menu.Item
                        active={isActiveBlock(2)}
                        index={2}
                        onClick={handleClick}
                        content="Optout/Wallets"
                    />
                    <Menu.Item
                        active={isActiveBlock(3)}
                        index={3}
                        onClick={handleClick}
                        content="Misc"
                    />
