...
export default function OptOutSegment() {
    ...
    return (
        ...
        >
            {vault.exists ? (
                <Header color="red">
                    Vault Found -- Delete Vault To Test These
                </Header>
            ) : null}
            ...
            <div className="flex justify-between">
                <div>
                    <Header
                        as="h3"
                        className="m-0"
                        content="Optout Wallet Management"
                    />
                    <div className="flex items-center">
                        <Header as="h6" className="m-0">
                            Vault Instance -- ( Keystore Wallets Still Get
                            Loaded Here )
                        </Header>
            ...
            <GenerateKeystoreForm
                ...
                showPassword
                submitFunction={addOptOutKeystore}
                customTitle={"Generate And Load Optout Keystore"}
            />
