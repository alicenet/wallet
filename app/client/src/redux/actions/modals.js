...
export function openRenameWalletModal(walletTarget) {
    return function (dispatch) {
        dispatch({
            type: MODAL_ACTION_TYPES.OPEN_RENAME_WALLET,
            payload: walletTarget,
        });
    };
}
...
export function openRemoveWalletModal(walletTarget) {
    return function (dispatch) {
        dispatch({
            type: MODAL_ACTION_TYPES.OPEN_REMOVE_WALLET,
            payload: walletTarget,
        });
    };
}
...
export function openXportPrivKModal(walletTarget) {
    return function (dispatch) {
        dispatch({
            type: MODAL_ACTION_TYPES.OPEN_XPORT_PRIVK,
            payload: walletTarget,
        });
    };
}
...
export function openXportKeyStoreModal(walletTarget) {
    return function (dispatch) {
        dispatch({
            type: MODAL_ACTION_TYPES.OPEN_XPORT_KS,
            payload: walletTarget,
        });
    };
}
