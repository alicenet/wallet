...
export default function PasswordRequestModal() {
    ...
    const [isOpen, reason, callback] = useSelector((s) => [
        s.modal.password_req_modal,
        s.modal.password_req_reason,
        s.modal.password_req_cb,
    ]);
    ...
    return (
        <Modal open={isOpen}>
            ...
            <Modal.Content>
                <Form
                    size="small"
                    className="mini-error-form text-left"
                    onSubmit={() => onSubmit(tryPassword)}
            ...
            <Modal.Actions>
                <div className="flex justify-between">
                    ...
                    <Button
                        content={
                            formState.password.error ? "Try Again" : "Submit"
                        }
                        color="teal"
