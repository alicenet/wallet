                    ...
                    <div className="p-4">
                        <Modal.Header>
                            <Header as="h4">
                                ...
                                <Header.Subheader>
                                    Give a friendly name in reference to
                                    address:{" "}
                        ...
                        <Modal.Content className="text-sm">
                            <p>
                                Renaming your wallet is considered an
                                administrative action.
                            </p>
                            <p>
                                Please provide your vault password and desired
                                wallet name below.
                            </p>
                    ...
                    <Modal.Actions className="border-solid border-t-1 border-b-0 border-l-0 border-r-0 border-gray-300 bg-gray-100 p-4">
                        <div className="flex justify-between">
                            ...
                            <Button
                                size="small"
                                content={
                                    error ? "Try Again" : "Save Wallet Name"
                                }
                                color="teal"
