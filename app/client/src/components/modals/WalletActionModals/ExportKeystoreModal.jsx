            ...
            <FocusTrap>
                <div className="p-6">
                    <Modal.Content className="text-sm">
                        ...
                        <p>
                            Please provide your vault password below as well as
                            a password for the exported keystore.
                        </p>
                        <p>
                            There are no restrictions on this password, but it
                            should be strong.
                        </p>
                        <Form
                            error={
                        ...
                        >
                            <Form.Group>
                                ...
                                <Form.Input
                                    width={6}
                                    type={
                                        storePassVisible ? "text" : "password"
                                    }
