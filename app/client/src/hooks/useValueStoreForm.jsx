 ...
 * @returns 
 */
export default function useValueStoreFormState(postVerifyCallback = () => { }, fromInit = "", toInit = "", valueInit = "", isBnInit = "") {
    ...
    const setStateByKey = (key, newVal) => setState(state => ({ ...state, [key]: newVal }))
    const setErrorByKey = (key, newErr) => setError(state => ({ ...state, [key]: newErr }))
