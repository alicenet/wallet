...
function UseRecoveryPhrase() {
    ...
    React.useEffect(() => {
        setParsedSeedPhrase(seedPhrase.split(' ').map(word => trim(word)).filter(word => word.length > 0));
    }, [seedPhrase]);
            ...
            <Grid textAlign="center">
                ...
                <Grid.Column className="flex flex-auto flex-col items-center gap-10">
                    ...
                    <Container className="flex flex-auto flex-col justify-center gap-10">
                        ...
                        <TextArea rows={4} value={seedPhrase} onChange={e => setSeedPhrase(e.target.value)}
