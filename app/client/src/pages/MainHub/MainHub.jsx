        ...
        <Grid textAlign="center" verticalAlign="middle">
            ...
            <Grid.Column width={16} className="mt-2 mb-2">
                ...
                <Modal
                    ...
                    open={openModal}
                    dimmer="inverted"
                    trigger={<div style={{cursor: 'pointer'}} className="text-purple-700 text-sm">What is a vault?</div>}
                >
                    ...
                    <Modal.Content>
                        ...
                        <Modal.Description className="flex flex-col items-center gap-10">
                            ...
                            <Container className="flex flex-auto flex-col gap-3 p-5 text-center">
                                ...
                                <p>Any wallets generated by MadWallet, imported via private key or imported via keystore
                                    are secured by your passphrase in the vault file.</p>

                                <p>Some users may not wish to subject to a single point of failure in wallet storage. To
                                    recognize this you will get the final say over how your wallets are stored and will
                                    be given the option to opt out of vault storage.</p>

                                <p>Please note that opting out of vault storage will make user flows more complicated,
                                    and you will be asked for individual key-store passwords frequently when loading and
                                    interacting with wallets. </p>
