...
async function main() {
    ...
    rl.question("\x1b[36mPrivate Key: \x1b[0m", async (enteredKey) => {
        ...
        console.log(
            "\n\x1b[36mSECP256K1       Derived Public Key: \x1b[0m",
            aliceNetWallet.Account.accounts[0].address
        );
        console.log(
            "\x1b[36mBARRETO-NAEHRIG Derived Public Key: \x1b[0m",
            aliceNetWallet.Account.accounts[1].address,
            "\n"
        );
